...
#### Q. Consider a program for determining the previous date. Its input is triple of day, month and year with the following ranges $1 \leq month \leq 12$, $1 \leq day \leq 31$, $1900 \leq year \leq 2015$.The possible output dates would be previous date or invalid date. Design the equivalence class test cases?
...
|E3|49|4|2022|Invalid date|
|E4|4|3|2011|3/3/2011|
|E5|2|-8|1976|Invalid date|
|E6|2|27|1976|Invalid date|
|E7|5|3|2011|4/3/2011|
|E8|2|7|1866|Invalid date|
|E9|2|7|2025|Invalid date|
...
|Input|Remarks|
|-----|-------|
|15/6/2035|Year outside accepted range (Invalid Date)|
|15/15/2011|Month outside accepted range (Invalid Date)|
|55/6/2011|Day outside accepted range (Invalid Date)|
|15/5/2011|All constraints satisfied (Valid Date)|
|31/4/2001|Boundary Value (Invalid Date)|
|31/2/2011|Boundary Value (Invalid Date)|
|23/2/1910|All constraints satisfied (Valid Date)|
|33/1/2011|Day outside accepted range (Invalid Date)|
|30/2/2000|Leap year (Valid Date)|
|31/12/2002|All constraints satisfied (Valid Date)|
|1/1/2005|All constraints satisfied (Valid Date)|
...
public class UnitTesting1 {
  ...
  public void test3() {
    int arr[] = { 15 };
    Programs program = new Programs();
    int output = program.linearSearch(15, arr);
    System.out.println(output);
    assertEquals(0, output);
  }
  @Test
...
public class UnitTesting2 {
  ...
  public void test2() {
    ...
    Programs program = new Programs();
    int output = program.countItem(50, input);
    assertEquals(output, 0);
  }
  @Test
  public void test3() {
  ...
  public void test4() {
    int input[] = { 41, 41, 42, 43, 41 };
    Programs program = new Programs();
    int output = program.countItem(42, input);
  ...
  public void test5() {
    int input[] = { 14 };
    Programs program = new Programs();
    int output = program.countItem(14, input);
    assertEquals(output, 1);
  }
  @Test
  public void test6() {
  ...
  @Test
  public void test7() {
    int input[] = { 81, 81, 72, 73, 81, 81, 81 };
    Programs program = new Programs();
...
|----------|---------------|
|v = 36 a = [2, 14, 36, 38, 510]|2|
|v = 12 a = [12, 14, 26, 38, 510]|0|
|v = 5510 a = [2, 14, 26, 38, 5510]|4|
|v = 512 a = [2, 14, 26, 38, 510]|-1|
...
public class UnitTesting3 {
  @Test
  public void test1() {
    int input[] = { 2, 14, 36, 38, 510 };
    Programs program = new Programs();
    int output = program.binarySearch(36, input);
    assertEquals(2, output);
  }
  @Test
  public void test2() {
    int input[] = { 12, 14, 26, 38, 510 };
    Programs program = new Programs();
  ...
  @Test
  public void test3() {
    int input[] = { 2, 14, 26, 38, 5510 };
    Programs program = new Programs();
    int output = program.binarySearch(5510, input);
  ...
  public void test6() {
    int input[] = { 15, 17, 19 };
    Programs program = new Programs();
    int output = program.binarySearch(15, input);
    assertEquals(0, output);
  }
  @Test
  public void test7() {
